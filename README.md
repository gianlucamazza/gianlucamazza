...
- [solana-mmaker](https://github.com/gianlucamazza/solana-mmaker) — market-making bot
  for Solana, automating strategies through the Jupiter swap protocol
...
- [xllama](https://github.com/gianlucamazza/xllama) — local LLM chat and Stable
  Diffusion on an Xbox Series S|X, CPU and DirectML
- [mcp_python_toolbox](https://github.com/gianlucamazza/mcp_python_toolbox) — MCP server
  giving AI assistants a real toolbox for Python development
- [mklang](https://github.com/gianlucamazza/mklang) — declarative language for
  LLM-driven state machines: the document is the program, the LLM is the runtime
